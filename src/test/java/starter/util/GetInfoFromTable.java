...
public class GetInfoFromTable {
    public static LoginModel getLoginCredencials(DataTable userLogin){
    ...
    public static TransactionModel getTransactionData(DataTable trasactionInfo){

        List<List<String>> rows = trasactionInfo.asLists(String.class);
